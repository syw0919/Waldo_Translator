    ...
    if message.content.startswith('!자가진단'):
        ...
        while ret != 0:
            ...
            try:
                ...
                await channel.send('코로나 의심 증상: 아니오')
                ...
                await channel.send('자가격리 여부: 아니오')
